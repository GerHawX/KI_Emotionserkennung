        ...
        <section id="main">
            ...
            <section id="ki1">
                <div class="kisection1">
                    ...
                    <p>Bitte gib die URL zu einem Bild an oder wähle ein Bild aus der Gallerie, in dem die Emotion eines Gesichts erkannt werden soll. Drücke anschließend den Button <strong>Analysieren</strong>.</p>
                        ...
                        <a href="#anker" class="scrolly">
                            <div class="content ">
                                <div class="media" onclick="showImage('bild1')">
                                    <img src="images/thumbs/frau1.jpg" id="bild1" alt="https://cdn.pixabay.com/photo/2020/02/22/21/21/burmese-woman-4871675_960_720.jpg " />
                                </div>
                                <div class="media " onclick="showImage('bild2')">
                                    <img src="images/thumbs/mann2.jpg" id="bild2" alt="https://cdn.pixabay.com/photo/2015/10/12/15/23/man-984504_960_720.jpg " title="This right here is a caption. " />
                                </div>
                                <div class="media " onclick="showImage('bild3')">
                                    <img src="images/thumbs/child1.jpg" id="bild3" alt="https://cdn.pixabay.com/photo/2015/04/24/20/59/girl-738306_960_720.jpg " title="This right here is a caption. " />
                                </div>
                                <div class="media " onclick="showImage('bild4')">
                                    <img src="images/thumbs/mann3.jpg" id="bild4" alt="https://cdn.pixabay.com/photo/2015/06/08/14/56/person-801789_960_720.jpg " title="This right here is a caption. " />
                                </div>
                                <div class="media " onclick="showImage('bild5')">
                                    <img src="images/thumbs/mann4.jpg" id="bild5" alt="https://cdn.pixabay.com/photo/2020/02/22/21/17/mime-4871669_960_720.jpg " title="This right here is a caption. " />
                                </div>
                                <div class="media " onclick="showImage('bild6')">
                                    <img src="images/thumbs/mann1.jpg" id="bild6" alt="https://cdn.pixabay.com/photo/2015/10/12/15/20/man-984433_960_720.jpg " title="This right here is a caption. " />
                                </div>
                                <div class="media " onclick="showImage('bild7')">
                                    <img src="images/thumbs/frau2.jpg" id="bild7" alt="https://cdn.pixabay.com/photo/2019/11/12/08/08/woman-4620433_960_720.jpg " title="This right here is a caption. " />
                                </div>
                                <div class="media " onclick="showImage('bild8')">
                                    <img src="images/thumbs/child2.jpg" id="bild8" alt="https://cdn.pixabay.com/photo/2016/09/27/10/10/baby-1697966_960_720.jpg " title="This right here is a caption. " />
                                </div>
                            </div>
                        </a>
                    </div>
